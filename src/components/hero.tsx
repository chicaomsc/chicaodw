    ...
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden min-h-screen flex items-center">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div
          ...
          <motion.h2
            variants={item}
            className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 font-poppins">
            <span className="block text-white">Engenheiro de Software</span>
            <span className="block text-5xl mt-4 bg-gradient bg-linear-to-r from-primary-light to-primary-dark bg-clip-text text-transparent">
          ...
          <motion.p
            ...
            Construindo soluções seguras, escaláveis e inovadoras desde 2014.
